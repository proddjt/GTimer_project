    ...
    <div class="container vw-100 vh-100">
        <div class="row h-100">
            <div class="col-12 h-100 d-flex justify-content-center align-items-center flex-column">
                ...
                <h3 class="fw-semibold fs-5">Accedi al tuo account GTimer per registrare i tuoi tempi</h3>
                <form class="w-50 d-flex flex-column justify-content-center align-items-center p-3" method="POST" action="{{ route('login') }}">
                    @csrf
                    ...
                    <button type="submit" class="button-highlight w-100">Login</button>
                </form>
                <p class="m-0 small">Non hai ancora un account? <a href="{{route('register')}}" class="redirect fw-semibold">Registrati ora</a></p>
